<header class="header-global">
    <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg warga-purple headroom py-lg-3 px-lg-6 navbar-dark navbar-theme-primary">
        <div class="container">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg">
                                <div class="col-auto px-0" data-dropdown-content>
                                    <div class="list-group list-group-flush">
                                        ...
                                        <a href="{{ route('auth.donations.logout') }}"
                                        ...
                                        <form id="account-logout-form" action="{{ route('auth.donations.logout') }}" method="POST" style="display: none;">
                                            @csrf
                                        </form>
                                        @else
                                        <a href="{{ route('auth.donations.login') }}"
                                            class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
                                        ...
                                        <a href="{{ route('auth.donations.register') }}"
                                            class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
