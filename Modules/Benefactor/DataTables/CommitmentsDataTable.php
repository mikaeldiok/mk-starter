...
class CommitmentsDataTable extends DataTable
{
    /**
     ...
     */
    public function __construct(CommitmentRepository $commitmentRepository)
    {
     ...
     *
     * @param \App\Commitment $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query()
    {
        $user = auth()->user();
        $data = $this->commitmentRepository->query()
                ->select('commitments.*')
                ->with(['donator']);
    ...
    {
        return 'Commitments_' . date('YmdHis');
    }
}